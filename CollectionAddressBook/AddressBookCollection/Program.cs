...
namespace AddressBookCollection
{
    ...
    internal class Program
    {
        ...
        //    AddressBookMain.Menu();//going inside this class and method
        //    MainMenu(string bookname)
...
//Enter FirstName: Luv
//Enter LastName: Sahu
//Enter Address : hjhsdjklh lj
//Enter City : asjd hj
//Enter State : sjh jld
//Enter zip : asjd jh
//Enter Contact No: 515161
//Enter Email: jhasbdj b
...
//Enter Your Choice:
//7
//Chooose option TO Sort Contacts by
//1. FirstName
//2. City
//3. State
//4. zip
...
//----------------------------------------------------------------------
//Shreegowri        koder           dsgh    Bng     kar    56788   wydhf    wjkdbc
//gagana    koder           hvs     cta     mp     jwdvc   whdkvc           kwhd
//******WELCOME TO ADDRESS BOOK******
//1.Add_Contact
//2.Display_Contact
//3.Delet_Contact
