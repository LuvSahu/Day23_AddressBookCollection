...
namespace AddressBookCollection
{
    ...
    {
        public static string path = @"D:\Bridgelabz\AddressBookCollection\AddressBookFile.txt";
        public static string csvPath = @"D:\Bridgelabz\AddressBookCollection\AddressBook.csv";
